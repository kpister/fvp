...
const (
	...
	ReturnCode_FAILURE_QUORUM  ReturnCode = 4
	ReturnCode_SUCCESS_SEQNO   ReturnCode = 5
)
...
func init() {
	...
	proto.RegisterType((*EmptyMessage)(nil), "kvstore.EmptyMessage")
...
var fileDescriptor_088d7f6aff848d9e = []byte{
	...
	,
}
...
type KeyValueStoreClient interface {
	...
	IncrementTerm(ctx context.Context, in *EmptyMessage, opts ...grpc.CallOption) (*EmptyMessage, error)
}
...
func (c *keyValueStoreClient) IncrementTerm(ctx context.Context, in *EmptyMessage, opts ...grpc.CallOption) (*EmptyMessage, error) {
	out := new(EmptyMessage)
	err := c.cc.Invoke(ctx, "/kvstore.KeyValueStore/IncrementTerm", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type KeyValueStoreServer interface {
	...
	IncrementTerm(context.Context, *EmptyMessage) (*EmptyMessage, error)
}
...
func (*UnimplementedKeyValueStoreServer) IncrementTerm(ctx context.Context, req *EmptyMessage) (*EmptyMessage, error) {
	return nil, status.Errorf(codes.Unimplemented, "method IncrementTerm not implemented")
}
...
func _KeyValueStore_IncrementTerm_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EmptyMessage)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(KeyValueStoreServer).IncrementTerm(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kvstore.KeyValueStore/IncrementTerm",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KeyValueStoreServer).IncrementTerm(ctx, req.(*EmptyMessage))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _KeyValueStore_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "IncrementTerm",
			Handler:    _KeyValueStore_IncrementTerm_Handler,
		},
	},
